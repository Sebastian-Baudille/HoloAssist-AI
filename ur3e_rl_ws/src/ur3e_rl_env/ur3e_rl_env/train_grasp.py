"""Train Sub-policy 3: descend EE to cube (grasp approach)."""
...
from ur3e_rl_env.envs.grasp_env import UR3eGraspEnv

_REPO     = Path(__file__).parent.parent.parent.parent.parent
MODEL_DIR = _REPO / "ur3e_rl_ws" / "rl_models" / "grasp"
...
def main():
    ...
    callbacks = [
        CheckpointCallback(save_freq=max(10_000 // args.envs, 1),
                           save_path=str(CKPT_DIR), name_prefix="grasp"),
