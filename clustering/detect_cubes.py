...
# Cluster size bounds. With the overhead camera (pitch=59°) near-side cubes
# produce up to ~1600 pts; far-side cubes ~1100 pts. Upper bound set to 2000
# to accommodate both while still rejecting large non-cube objects.
MIN_CLUSTER_PTS = 50
