...
All the environments are registered in the `holoassist_tasks` extension. They start
...
import holoassist_tasks.tasks  # noqa: F401


def main():
    """Print all environments registered in `holoassist_tasks` extension."""
